...
Any gate assertion failed, or a soft is below its threshold --strict  → failed
...
- [Write send](/guides/write-send) — how the standard event stream is produced, and what scoped assertions depend on.
