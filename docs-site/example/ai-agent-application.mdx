...
pnpm exec fasteval exp compare-models   # run the model comparison experiment
pnpm exec fasteval exp compare-models weather-tool   # run one eval inside that experiment
```
