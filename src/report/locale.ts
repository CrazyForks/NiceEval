...
const en = {
  ...
  "caseList.empty": "No failed or errored attempts",
  "caseList.truncated": "and {n} more not shown",
  "caseList.truncatedText": "({n} more not shown)",
  "caseList.viewAttempt": "view attempt",
  "caseList.score": "score {score}",
  "caseList.details": "details",
...
const zhCN: Record<ReportMessageKey, string> = {
  ...
  "caseList.empty": "没有失败或出错的 attempt",
  "caseList.truncated": "还有 {n} 条未列出",
  "caseList.truncatedText": "(还有 {n} 条未列出)",
  "caseList.viewAttempt": "查看 attempt",
  "caseList.score": "得分 {score}",
  "caseList.details": "详情",
