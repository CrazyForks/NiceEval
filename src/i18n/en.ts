...
export const en = {
  ...
  "otel.noneMatched": "otel: received {{count}} spans, no dialect derived any events; span names: {{names}}",
  "otel.noneMatchedExplicit": "otel: received {{count}} spans, 0 matched the {{dialects}} format(s); span names: {{names}}",
  "otel.recognized": "otel: {{summary}} ({{total}} spans total)",
  "otel.unpairedCalls": "otel: {{calls}} action.called but only {{results}} results — instrumentation may not cover the tool layer",
