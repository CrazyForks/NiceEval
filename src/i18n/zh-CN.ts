export const zhCN = {
  ...
  "otel.noneMatched": "otel:收到 {{count}} 条 span,没有方言识别出事件;span 名:{{names}}",
  "otel.noneMatchedExplicit": "otel:收到 {{count}} 条 span,0 条命中 {{dialects}} 格式;span 名:{{names}}",
  "otel.recognized": "otel:{{summary}}(共 {{total}} span)",
  "otel.unpairedCalls": "otel:{{calls}} 次 action.called 只配到 {{results}} 个 result —— 埋点可能没盖住工具层",
